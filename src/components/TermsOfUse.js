      ...
      <div className={classes.container}>
        ...
        <div className={classes.textBox}>
          ...
          <p className={classes.normalText}>
            ...
            at https://FilmInc.pl or through our mobile application H&M Online
            Shop, you are agreeing to be bound by all these Website’s Terms of
            Use and agree with any applicable local laws. If you disagree with
            any of these terms, you are prohibited from accessing this Website
            or using the Service. All materials in this Website are protected by
          ...
          <p className={classes.normalText}>
            We advise you to read our privacy policy regarding our user data
          ...
          <strong>support@filmInc.pl</strong>
        </div>
      </div>
    </>
  );
