      ...
      <div className={classes.container}>
        ...
        <div className={classes.textBox}>
          <p className={classes.normalText}>
            At FilmInc , accessible at https://FilmInc.pl, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document is designed to help you understand how we collect, use and
            safeguard the information you provide to us.
          </p>
          ...
          <p className={classes.normalText}>
            FilmInc and Services may use third-party analytics tools that uses
